...
"")
        ...
        self.add_list_button = QPushButton(self.tab)
        self.add_list_button.setObjectName(u"add_list_button")
        self.add_list_button.setMinimumSize(QSize(0, 35))
        self.add_list_button.setStyleSheet(u"QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
...
"}")
        ...
        self.verticalLayout.addWidget(self.add_list_button)

        self.tags_listWidget = QListWidget(self.tab)
        self.tags_listWidget.setObjectName(u"tags_listWidget")
        self.tags_listWidget.setStyleSheet(u" QListView {\n"
"   	border: 3px solid rgb(85, 123, 226);\n"
"	border-color: rgb(85, 123, 226);\n"
"	border-radius: 6px;\n"
" }\n"
"")

        self.verticalLayout.addWidget(self.tags_listWidget)

        self.clear_list_button = QPushButton(self.tab)
        self.clear_list_button.setObjectName(u"clear_list_button")
        self.clear_list_button.setMinimumSize(QSize(0, 35))
        self.clear_list_button.setStyleSheet(u"QPushButton {\n"
"	color: rgb(255, 255, 255);\n"
"	font: 700 12pt \"Segoe UI\";\n"
"	padding-bottom: 5px;\n"
"	border: 3px solid rgb(85, 123, 226);\n"
...
"}")
    ...
    def retranslateUi(self, Dialog_settings):
        ...
        self.add_list_button.setText(QCoreApplication.translate("Dialog_settings", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c", None))
        self.clear_list_button.setText(QCoreApplication.translate("Dialog_settings", u"\u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Dialog_settings", u"   \u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u0441\u043f\u0438\u0441\u043a\u0430 \u0442\u0435\u0433\u043e\u0432   ", None))
